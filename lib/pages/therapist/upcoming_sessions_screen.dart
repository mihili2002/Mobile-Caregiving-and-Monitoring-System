...
class UpcomingSessionsScreen extends StatelessWidget {
  ...
  // ✅ Frontend-only demo sessions list
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            // Text(
            //   "Note: This is frontend-only demo data for supervisor presentation.",
          ...
          children: [
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(session.elderName, style: const TextStyle(fontWeight: FontWeight.w900)),
                ...
                Container(
                  ...
                  child: Text(session.mode, style: const TextStyle(fontWeight: FontWeight.w700)),
                ),
              ],
            ),
            ...
            Row(
              children: [
                ...
                Expanded(child: Text("${session.dateText} • ${session.timeText}")),
              ],
            ),
            const SizedBox(height: 10),

            // ✅ ONLY these 2 buttons (no generate)
            Wrap(
              spacing: 8,
              runSpacing: 8,
              children: [
