...
class UserService {
  ...
  Future<Map<String, dynamic>?> createElderProfile(
    ...
    try {
      ...
      debugPrint("createElderProfile failed: ${response.statusCode} ${response.body}");
      return null;
    } catch (e) {
  ...
  Future<AppUser?> getUser(String uid) async {
    ...
    // ✅ FIX: AppUser.fromMap now accepts uidOverride named param
  ...
  /// ✅ Update role with consistent string mapping
  ...
  /// ✅ Get users by role (uses your role string converter)
  Future<List<AppUser>> getUsersByRole(UserRole role) async {
    final roleStr = userRoleToString(role);
